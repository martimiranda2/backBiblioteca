    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, null=True, verbose_name='Telèfon')),
                ...
                ('date_of_birth', models.DateField(null=True, verbose_name='Data de naixement')),
                ...
                ('center', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='biblioApp.center', verbose_name='Centre')),
